...
<body>
    ...
    <footer>
        <div id="information-area">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 col-md-3 information-box">
                        <i class="fas fa-map-marker-alt"></i>
                        <h5>Endereço</h5>
                        <p>123 - Centro<br>Pouso Alegre-MG</p>
                    </div>
                    <div class="col-6 col-md-3 information-box">
                        <i class="fas fa-envelope"></i>
                        <h5>E-mail</h5>
                        <p class="email">contato@embarque.com</p>
                    </div>
                    <div class="col-6 col-md-3 information-box">
                    ...
                    <div class="col-6 col-md-3 p-3 information-box">
                        <h5>Siga-nos</h5>
